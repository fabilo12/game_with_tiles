...
The simplest way to play the game is to clone this repo and run `npm start` in the project directory.
...
The project was bootstrapped with [Create React App](https://github.com/facebook/create-react-app). In the project directory, you can run:
